            ...
            <section className="projects">
                <div className="project-item">
                    ...
                    <div className="project-content">
                        ...
                        <a href="https://yourproject1.com" target="_blank" className="btn">View Project</a>
                    </div>
                </div>
                <div className="project-item">
                    <img src="pc.png" alt="Project 2" className="project-image" />
                    <div className="project-content">
                        <h3>KhmerST Model</h3>
                        ...
                        <a href="pc.png" target="_blank" className="btn">View Project</a>
                    </div>
                </div>
                <div className="project-item">
                    <img src="/pc.png" alt="Project 3" className="project-image" />
                    <div className="project-content">
                        ...
                        <a href="/path/to/project3" target="_blank" className="btn">View Project</a>
                    </div>
                </div>
                <div className="project-item">
                    <img src="/pc.png" alt="Project 4" className="project-image" />
                    <div className="project-content">
                ...
                <div className="project-item">
                    <img src="/pc.png" alt="Project 5" className="project-image" />
                    <div className="project-content">
                ...
                <div className="project-item">
                    <img src="/pc.png" alt="Project 6" className="project-image" />
                    <div className="project-content">
